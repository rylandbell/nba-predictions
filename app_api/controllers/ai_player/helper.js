...
module.exports.createProbabilityMatrix = function(rawData, teams) {
  ...
  function markProbabilities(dayObject) {
    ...
    probabilityObject[dayObject.team1][dayNumber] =
      100 - Math.round(dayObject.carmelo_prob1 * 100);
    probabilityObject[dayObject.team2][dayNumber] =
      100 - Math.round(dayObject.carmelo_prob2 * 100);
  }
  ...
  const filteredData = rawData.forEach(markProbabilities);

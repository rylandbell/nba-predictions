...
class UpcomingPicks extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const currentMonthSelected =
      this.props.activeMonth === this.props.currentMonth;
    ...
    const secondDate = moment(this.props.activeMonth + "-" + firstDay).add(
      1,
      "days"
    );
    const thirdDate = moment(this.props.activeMonth + "-" + firstDay).add(
      2,
      "days"
    );
      ...
      <div>
        <table className="table upcoming-picks-table">
          ...
          <tbody>
            <tr>
              <UpcomingPicksTeam
                day={parseInt(firstDay, 10)}
                date={firstDate.format("YYYY-MM-DD")}
                activeMonth={this.props.activeMonth}
                activeUserMonth={this.props.activeUserMonth}
                goToDate={this.props.goToDate}
              />
              <UpcomingPicksTeam
                day={parseInt(firstDay, 10) + 1}
              ...
              />
              <UpcomingPicksTeam
                day={parseInt(firstDay, 10) + 2}
                date={thirdDate.format("YYYY-MM-DD")}
                activeMonth={this.props.activeMonth}
                activeUserMonth={this.props.activeUserMonth}
                goToDate={this.props.goToDate}
              />
        ...
        >
          Update {moment(this.props.activeMonth).format("MMMM")} Picks
        </button>
      </div>
    );
  }

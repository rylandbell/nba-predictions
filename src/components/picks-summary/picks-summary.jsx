...
const PicksSummary = React.createClass({
  render: function() {
    ...
    if (this.props.missingUserMonth) {
      panelContent = <JoinMonth activeMonth={this.props.activeMonth} activeLeagueId={this.props.activeLeagueId} createNewUserMonth={this.props.createNewUserMonth} showingTours={this.props.showingTours}/>;

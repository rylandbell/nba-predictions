      ...
      return (
        <div className={'row '+(this.props.reduxState.fetchStatus.isSendingPrediction ? 'send-waiting' : '')}>
          ...
          <div className="col-xs-12 col-sm-4 col-md-3">
            <MonthlyPicksMonthSelector selectedPicksMonth = {this.props.reduxState.selectedPicksMonth} setPicksMonth = {this.props.setPicksMonth} getUserMonthData={this.props.getUserMonthData} getGameData={this.props.getGameData} />

...
const MonthlyPicksPage = React.createClass({
  ...
  render: function() {
    const isLoading = this.props.fetchStatus.isFetchingUserMonthData || this.props.fetchStatus.isFetchingGameData || this.props.fetchStatus.isFetchingUserData;
    ...
    if (isLoading) {
      ...
      return (
        <div className={'row '+(this.props.fetchStatus.isSendingPrediction ? 'send-waiting' : '')}>
          <div className="col-xs-12 col-sm-6 col-sm-offset-1 col-md-5 col-md-offset-2">
            <div className="panel panel-black panel-default">
              ...
              <div className="panel-body">
                <JoinMonth activeMonth={this.props.dates.activeMonth} activeLeagueId={this.props.activeLeagueId} createNewUserMonth={this.props.createNewUserMonth} getUserMonthData={this.props.getUserMonthData} />
              </div>
            </div>  
          </div>
        </div>)

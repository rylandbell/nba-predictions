...
export function runDashboardIntro(dispatch, joinPhrase) {
  ...
  const xsSteps = [
    ...
    },
    {
      ...
      intro:
        "This dropdown menu contains links to the rest of the site, including two important pages. The <strong>Leagues</strong> page lets you create a new league, join a friend's league, and view info about your current league(s). And the <strong>How-to-Play</strong> page explains the rules of the game."
    },
    {
      element: document.querySelector(".picks-summary"),
      intro:
        "Now let's make some actual picks! Click the Sign Up button to join the selected month's competition."
    }
  ];
  ...
  const regSteps = [
    ...
    },
    {
      ...
      intro:
        'The "More" menu contains links to two important pages. The <strong>Leagues</strong> page lets you create a new league, join a friend\'s league, and view info about your current league(s). And the <strong>How-to-Play</strong> page explains the rules of the game.'
    },
    {
      element: document.querySelector(".league-month-picker"),
      intro:
        "Here you can change the league and month for which you're making picks and viewing results."
    },
    {
      element: document.querySelector(".picks-summary"),
      intro:
...
export function runPicksIntro(dispatch) {
  ...
  intro.setOptions({
    steps: [
      {
        intro:
          "Pick a winner by clicking on a logo. You can change picks any time before tip-off, so don't be shy about picking future games. Have fun!"
      }
    ],
    showProgress: false,
    showBullets: false,
